...
#define G_SSR_WATER_SCREENFADE			0.0f	// Screen border fade. ( 0.0f = No border fade )
...
#define G_SSR_WEAPON_INTENSITY  		0.6f	// Weapons & arms reflection intensity. ( 1.0f = 100% ~ 0.0f = 0% [ % in relation to G_SSR_INTENSITY ] )
#define G_SSR_WEAPON_MAX_INTENSITY		0.05f	// Weapons & arms max intensity.
