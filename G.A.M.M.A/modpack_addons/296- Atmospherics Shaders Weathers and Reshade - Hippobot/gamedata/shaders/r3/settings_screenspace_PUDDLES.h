...
#define G_PUDDLES_GLOBAL_SIZE				0.95f	// Puddles global size. ( This affect distance and puddles size )
...
#define G_PUDDLES_TERRAIN_EXTRA_WETNESS		0.2f	// Terrain extra wetness when raining. ( Over time like puddles )
#define G_PUDDLES_REFLECTIVITY				0.55f	// Reflectivity. ( 1.0f = Mirror like )
...
#define G_PUDDLES_RIPPLES_SPEED				0.95f	// Puddles ripples movement speed
...
#define G_PUDDLES_REFRACTION_INTENSITY		0.7f	// Refraction intensity
