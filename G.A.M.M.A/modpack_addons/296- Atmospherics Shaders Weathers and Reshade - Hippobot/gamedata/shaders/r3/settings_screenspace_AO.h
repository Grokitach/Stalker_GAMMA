...
#define G_SSDO_RADIUS 					0.3f	// AO radius, higher values means more occlusion coverage with less detail and intensity. ( Recommended 0.1 ~ 0.5 )
#define G_SSDO_INTENSITY 				7.0f 	// General AO intensity.

#define G_SSDO_FLORA_INTENSITY 			0.9f 	// Flora intensity. [ 1.0f = 100% ~ 2.0f = 200% ]

#define G_SSDO_NOISE_MIN 				0.15f	// Minimum noise intensity.
#define G_SSDO_NOISE_MAX 				1.0f 	// Maximum noise intensity. ( Noise increase intensity through distance )

#define G_SSDO_MAX_OCCLUSION			0.05f 	// Maximum obscurance for a pixel. 0 = full black
#define G_SSDO_SMOOTH 					1.65f 	// AO softer. Highly occluded pixels will be more affected than low occluded ones.
...
#define G_SSDO_WEAPON_INTENSITY			0.7f	// Weapon intensity. [ 1.0f = 100% ]
