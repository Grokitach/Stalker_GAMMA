...
#define G_SSR_INTENSITY					0.82f	// Global reflection intensity ( 1.0f = 100% ~ 0.0f = 0% )
#define G_SSR_MAX_INTENSITY				0.39f	// Global reflection MAX intensity.
#define G_SSR_SKY_INTENSITY				0.5f	// Sky reflection intensity ( 1.0f = 100% ~ 0.0f = 0% )
#define G_SSR_FLORA_INTENSITY 			0.45f	// Adjust grass and tree branches intensity
#define G_SSR_TERRAIN_BUMP_INTENSITY	0.80f	// Terrain bump intensity ( Lower values will generate cleaner reflections )
...
#define G_SSR_WEAPON_RAIN_FACTOR		0.16f	// Weapons reflections boost when raining ( 0 to disable ) ( Affected by rain intensity ))
