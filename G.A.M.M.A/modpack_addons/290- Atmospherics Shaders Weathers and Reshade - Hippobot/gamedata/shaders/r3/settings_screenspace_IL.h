...
#define G_IL_QUALITY				0		// Quality of the IL [ 0 = Very Low | 1 = Low | 2 = Normal | 3 = High ]

#define G_IL_INTENSITY				1.05f	// Intensity of the indirect ilumination
#define G_IL_SKYLIGHT_INTENSITY		0.35f	// Intensity of the sky light
#define G_IL_COLOR_VIBRANCE			1.35f	// Vibrance of the indirect ilumination
...
#define G_IL_WEAPON_RANGE 			0.02f	// Weapons radius for the IL sampling
